...
<html>
    ...
    <body>
            ...
            <form id="form_seleccion" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                ...
                <select name="cod_prod">
                    <?php foreach ($productos as $value):?>
                       <?php if($codProd==$value["cod"]) :?>    <!--para ver si he enviado el formulario, mostrar el producto que he enviado-->
        ...
        <div id="contenido">
            ...
            <?php if (isset($codProd) && count($stock) != 0): //Si tengo código enviado?>
